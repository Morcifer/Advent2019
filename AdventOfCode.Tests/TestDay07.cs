...
public class TestDay07
{
    ...
    public void Day7RunOnceAndTestProgramOutput(long[] program, long[] inputs, long expectedOutput)
    {
    ...
    public void Day7RunToEndAndTestProgramOutput(long[] program, long[] inputs, long expectedOutput)
    {
    ...
    [Theory]
    [InlineData(typeof(Day07), RunMode.Real, "30940", "76211147")]
